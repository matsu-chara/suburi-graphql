...
func (s shortMapper) Mutation_createAccount(ctx context.Context, account AccountInput) (*Account, error) {
	return s.r.Mutation().CreateAccount(ctx, account)
}

func (s shortMapper) Mutation_createProduct(ctx context.Context, product ProductInput) (*Product, error) {
	return s.r.Mutation().CreateProduct(ctx, product)
}

func (s shortMapper) Mutation_createOrder(ctx context.Context, order OrderInput) (*Order, error) {
	return s.r.Mutation().CreateOrder(ctx, order)
}

func (s shortMapper) Query_accounts(ctx context.Context, pagination *PaginationInput, id *string) ([]Account, error) {
	return s.r.Query().Accounts(ctx, pagination, id)
}

func (s shortMapper) Query_products(ctx context.Context, pagination *PaginationInput, query *string, id *string) ([]Product, error) {
	return s.r.Query().Products(ctx, pagination, query, id)
}
